...
export default function Navbar({ isOpen = true, onClose }: NavbarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`
          sidebar-viewport w-56 grid grid-rows-[auto_1fr_auto] min-h-0 shrink-0 overflow-hidden bg-[#124d25] text-[#f0fdf4] font-semibold shadow-sm
        ...
        `}
      >
      <div className="min-h-0 pt-4 pb-4 px-5 border-b border-white/20 relative">
        <button
          type="button"
      ...
      <nav className="min-h-0 overflow-y-auto overflow-x-hidden px-5 py-3">
        <ul className="menu menu-vertical w-full gap-1">
          <li>
            <Link to="/dashboard" className="flex items-center gap-2" {...linkProps}>
          ...
          <li>
            <Link to="/dogs" className="flex items-center gap-2" {...linkProps}>
              <svg xmlns="http://www.w3.org/2000/svg" className={iconClass} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
          ...
          <li>
            <Link to="/parks" className="flex items-center gap-2" {...linkProps}>
              <svg xmlns="http://www.w3.org/2000/svg" className={iconClass} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
          ...
          <li>
            <Link to="/visits" className="flex items-center gap-2" {...linkProps}>
              <svg xmlns="http://www.w3.org/2000/svg" className={iconClass} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
          ...
          <li>
            <Link to="/settings" className="flex items-center gap-2" {...linkProps}>
              <svg xmlns="http://www.w3.org/2000/svg" className={iconClass} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
          ...
          {user?.is_admin && (
            <li>
              <Link to="/admin" className="flex items-center gap-2" {...linkProps}>
                <svg xmlns="http://www.w3.org/2000/svg" className={iconClass} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
